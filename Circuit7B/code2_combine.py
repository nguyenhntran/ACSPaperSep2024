...
# -----------
  ...
  filename0 = 'circuit2_steadystates' + str(ifile) + '.npz'
  
  filename6 = 'circuit2_PreParetos_Sens1' + str(ifile) + '.npz' #new
  
  filename1 = 'circuit2_Paretos_Sens1' + str(ifile) + '.npz'
  filename3 = 'circuit2_Paretos_Params1' + str(ifile) + '.npz'
...
np.savez('circuit2_SteadyStates_final.npz',
...
np.savez('circuit2_Paretos_Sens1_final.npz',
...
np.savez('circuit2_Paretos_Param1_final.npz', 
...
np.savez('circuit2_PreParetos_Sens1_final.npz',
