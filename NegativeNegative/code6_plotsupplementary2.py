# Plots supplementary figure associated with steady state 2
...
# Load data
data = np.load('Toggle_Paretos_Sens2_final.npz')
for key, value in data.items():
    globals()[key] = value

# Create a 5x3 grid for subplots
fig, axs = plt.subplots(4, 3, figsize=(8,10))  # Adjust figsize as needed for clarity
fig.suptitle('Double negative: all sensitivity combinations of equilibrium 2')
...
pareto_sets = [
    paretoset_Sens2Pair1_final, paretoset_Sens2Pair2_final, paretoset_Sens2Pair4_final, 
    paretoset_Sens2Pair5_final, paretoset_Sens2Pair6_final, paretoset_Sens2Pair8_final, 
    paretoset_Sens2Pair9_final, paretoset_Sens2Pair11_final, paretoset_Sens2Pair12_final, 
    paretoset_Sens2Pair15_final
]
...
plt.savefig("toggle_ss2_supp.pdf", dpi=600, bbox_inches='tight')
plt.show()
