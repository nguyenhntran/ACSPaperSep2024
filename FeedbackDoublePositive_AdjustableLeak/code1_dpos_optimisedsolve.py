...
np.savez('dpos_steadystates' + str(betaindex) + '.npz', xss1=xss1, xss2=xss2, yss1=yss1, yss2=yss2)
...
def S_betax_xss_analytic(xss, yss, beta_x, beta_y, n):                                               #|
    numer = yss**(1 + n) * beta_x * (L - xss + beta_x) * (beta_y**2)
...
def S_betax_yss_analytic(xss, yss, n, beta_x, beta_y):                                               #|
    numer = n * (L - xss) * (L - yss) * (beta_x**2) * (L - yss + beta_y)
    denom = (L - xss + beta_x) * (-L * (L - xss) * yss * (1 + yss**n)**2 * beta_y - yss**(1 + n) * (1 + yss**n) * (beta_x**2) * beta_y + beta_x * (n**2 * (L - xss) * (L - yss)**2 + (L**2 * n**2 + xss * yss * (n**2 + yss**n + yss**(2 * n)) - L * (n**2 * (xss + yss) + yss * (1 + 3 * yss**n + 2 * yss**(2 * n)))) * beta_y))
    sensitivity = - numer/denom                                                                      #|
    return abs(sensitivity)                                                                          #|
                                                                                                     #|
# ____________________________                                                                       #|
...
def S_betay_yss_analytic(xss, yss, n, beta_x, beta_y):                                               #|
    numer = xss**(1 + n) * (beta_x**2) * beta_y * (L - yss + beta_y)
    denom = (-L + xss - beta_x) * (L * (L - xss) * yss * (1 + yss**n)**2 * beta_y + yss**(1 + n) * (1 + yss**n) * (beta_x**2) * beta_y + beta_x * (-n**2 * (L - xss) * (L - yss)**2 + (-L**2 * n**2 + L * n**2 * (xss + yss) - xss * yss * (n**2 + yss**n + yss**(2 * n)) + L * yss * (1 + 3 * yss**n + 2 * yss**(2 * n))) * beta_y))
    sensitivity = - numer/denom                                                                      #|
    return abs(sensitivity)                                                                          #|
                                                                                                     #|
# ____________________________                                                                       #|
...
def S_n_yss_analytic(xss, yss, n, beta_x, beta_y):                                                   #|
    numer = n * (L - yss) * (L - yss + beta_y) * (-L * (-1 + yss**(2*n)) * (L - xss) * np.log(xss) + (n * (L - xss) * np.log(yss) - (2*L * yss**(2*n) + xss - yss**(2*n) * xss) * np.log(xss)) * beta_x - yss**(2*n) * np.log(xss) * beta_x**2)
    denom = -L * (L - xss) * yss * (1 + yss**n)**2 * beta_y - yss**(1 + n) * (1 + yss**n) * beta_x**2 * beta_y + beta_x * (n**2 * (L - xss) * (L - yss)**2 + (L**2 * n**2 + xss * yss * (n**2 + yss**n + yss**(2*n)) - L * (n**2 * (xss + yss) + yss * (1 + 3*yss**n + 2*yss**(2*n)))) * beta_y)
    sensitivity = - numer/denom                                                                      #|
    return abs(sensitivity)                                                                          #|
                                                                                                     #|
...
np.savez('dpos_Paretos_Sens1' + str(betaindex) + '.npz',                                                 #|
...
paretoset_Sens2Pair15 = Sens2Pair15[Sens2mask15]                                                         #|
                                                                                                         #|
# Save tables of Pareto points for each sensitivity pair                                                 #|
np.savez('dpos_Paretos_Sens2' + str(betaindex) + '.npz',                                                 #|
...
# Save the arrays                                                                        #|
                                                                                         #|
np.savez('dpos_Paretos_Params1' + str(betaindex) + '.npz',                               #|
			...
			paretoset_Sens1mask15_Param = paretoset_Sens1mask15_Param)                   #|
                                                                                         #|
np.savez('dpos_Paretos_Params2' + str(betaindex) + '.npz',                               #|
